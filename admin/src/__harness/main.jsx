...
const Pages = { navigation: Navigation, offices: Offices, contact: Contact, media: Media, audit: Audit, gallery: Gallery, activity: Activity, people: People, giftreq: GiftReq, faqs: Faqs, blog: Blog };
